...
- `TRANSCRIPT-<date>.md` — real captured output of the run **on that date**
  (generated by the script, never hand-written). A transcript is a dated
  ...
  `TRANSCRIPT-2026-09-16.md` is the current capture and shows the fixed
  behaviour: `PASS: template body carried the session_id (body slot populated)`.
